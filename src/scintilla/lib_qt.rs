...
use plygui_api::traits::{UiContainer, UiControl, UiHasLayout, UiMember};
use plygui_api::{callbacks, development, layout, types};
...
impl development::UiDrawable for Scintilla {
    fn draw(&mut self, coords: Option<(i32, i32)>) {
        ...
        if let Some(coords) = self.base.coords {
            ...
            self.base.widget.as_mut().set_fixed_size((self.base.measured_size.0 as i32 - lm - rm, self.base.measured_size.1 as i32 - rm - bm));
        }
    }
